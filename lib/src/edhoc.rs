...
fn encode_plaintext_2_psk(c_r: ConnId, ead_2: &EadItems) -> Result<BufferPlaintext2, EDHOCError> {
    let mut plaintext_2: BufferPlaintext2 = BufferPlaintext2::new();
    let c_r = c_r.as_cbor();
...
mod tests {
    ...
    const KEYSTREAM_3A_PSK_TV: [u8; MESSAGE_3_PSK_TV.len() - 1] = hex!("03e5d1571bbc9332471b");
    ...
    const _ENC_STRUCURE_MESSAGE_3: EdhocBuffer<MAX_BUFFER_LEN> = EdhocBuffer::new_from_array(&hex!(
